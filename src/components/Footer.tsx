    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">IA Vendas Pro</h3>
            <p className="text-gray-400 mb-4">
              Revolucione suas vendas digitais com o poder da Inteligência Artificial.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Política de Reembolso</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} IA Vendas Pro. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
